        ...
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 '>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                    ...
                    <p>Navegue por nossa lista de médicos confiáveis e <br className='hidden sm:block' /> agende suas consultas sem complicações.</p>
                </div>
                <a href='#speciality' className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-[#595959] text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'>
                    Ver especialidades <img className='w-3' src={assets.arrow_icon} alt="" />
                </a>
            </div>
